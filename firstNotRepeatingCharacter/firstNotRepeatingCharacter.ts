...
console.log(firstNotRepeatingCharacter("philadelphia")); // DEUVELVE d
console.log(firstNotRepeatingCharacter("acabata")); // DEVUELVE c
console.log(firstNotRepeatingCharacter("ratatouille")); // DEVUELVE r
console.log(firstNotRepeatingCharacter("abacacaba")); // DEVUELVE _
